...
function showInitiativeOrder(list) {
    instructions.textContent = "Who's up next...?";
    combatants.classList.add("hidden");
        ...
        li.innerHTML = `
            <div class="w-2/3 mx-auto space-y-2">
                ...
                <div class="flex items-center justify-around">
                    ...
                    <select name="condition" class="py-1 w-1/2 font-roboto text-xl font-bold">
                ...
                <div class="flex items-center justify-around">
                    ...
                    <button class="dead-btn py-1 w-1/2 font-roboto text-xl font-bold uppercase bg-red cursor-pointer">Dead</button>
                </div>
            </div>
        `;
    ...
    const deadBtn = slidesContainer.querySelectorAll(".dead-btn");

    deadBtn.forEach(button => {
        button.addEventListener("mousedown", () => {
            const li = button.closest("li.glide__slide");
            const nameHeading = li?.querySelector("h2");
    
            if (nameHeading) {
                nameHeading.classList.add("text-red");
            }
        });
    ...
    nextBtn.addEventListener("click", resetTracker)
}
...
function resetTracker() {
    ...
    combatants.classList.remove("hidden", "justify-between", "w-2/3");
