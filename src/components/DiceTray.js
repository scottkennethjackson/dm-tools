    ...
    <>
      ...
      {isTrayOpen && (
        <button
          ...
          className={`
            flex justify-center items-center absolute top-3.5 left-0 z-30 ps-12.25 pe-6 min-w-48 h-13 font-roboto text-xl font-bold bg-red active:bg-activered rounded-full cursor-pointer transform transition-transform duration-300
      ...
      >
        ...
        >
          <svg
            aria-hidden="true"
            focusable="false"
            className="size-10 fill-red group-active:fill-activered"
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 -960 960 960"
          >
